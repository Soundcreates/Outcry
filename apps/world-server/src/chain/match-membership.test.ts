...
legacyData.fill(0, 83, 211);
wallet.toBuffer().copy(legacyData, 83);
wallet.toBuffer().copy(legacyData, 211 + 2 * 32);
assert.equal(isMatchMemberAtSeat(legacyData, wallet, 2), true);
currentData[82] = 1;
...
currentData.fill(0, 84, 212);
wallet.toBuffer().copy(currentData, 84);
wallet.toBuffer().copy(currentData, 212 + 2 * 32);
assert.equal(isMatchMemberAtSeat(currentData, wallet, 2), true);
